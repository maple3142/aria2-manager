...
*/
if("undefined"==typeof jQuery)throw new Error("AdminLTE requires jQuery");!function(o){"use strict";function i(e,t){if(this.element=e,this.options=t,this.$overlay=o(t.overlayTemplate),""===t.source)throw new Error("Source url was not defined. Please specify a url in your BoxRefresh source option.");this._setUpListeners(),this.load()}var a="lte.boxrefresh",s={source:"",params:{},trigger:".refresh-btn",content:".box-body",loadInContent:!0,responseType:"",overlayTemplate:'<div class="overlay"><div class="fa fa-refresh fa-spin"></div></div>',onLoadStart:function(){},onLoadDone:function(e){return e}},e='[data-widget="box-refresh"]';function t(r){return this.each(function(){var e=o(this),t=e.data(a);if(!t){var n=o.extend({},s,e.data(),"object"==typeof r&&r);e.data(a,t=new i(e,n))}if("string"==typeof t){if(void 0===t[r])throw new Error("No method named "+r);t[r]()}})}i.prototype.load=function(){this._addOverlay(),this.options.onLoadStart.call(o(this)),o.get(this.options.source,this.options.params,function(e){this.options.loadInContent&&o(this.element).find(this.options.content).html(e),this.options.onLoadDone.call(o(this),e),this._removeOverlay()}.bind(this),""!==this.options.responseType&&this.options.responseType)},i.prototype._setUpListeners=function(){o(this.element).on("click",this.options.trigger,function(e){e&&e.preventDefault(),this.load()}.bind(this))},i.prototype._addOverlay=function(){o(this.element).append(this.$overlay)},i.prototype._removeOverlay=function(){o(this.$overlay).remove()};var n=o.fn.boxRefresh;o.fn.boxRefresh=t,o.fn.boxRefresh.Constructor=i,o.fn.boxRefresh.noConflict=function(){return o.fn.boxRefresh=n,this},o(window).on("load",function(){o(e).each(function(){t.call(o(this))})})}(jQuery),function(o){"use strict";function i(e,t){this.element=e,this.options=t,this._setUpListeners()}var a="lte.boxwidget",s={animationSpeed:500,collapseTrigger:'[data-widget="collapse"]',removeTrigger:'[data-widget="remove"]',collapseIcon:"fa-minus",expandIcon:"fa-plus",removeIcon:"fa-times"},e=".box",t=".collapsed-box",l=".box-header",u=".box-body",c=".box-footer",d=".box-tools",f="collapsed-box",r="collapsing.boxwidget",p="collapsed.boxwidget",h="expanding.boxwidget",g="expanded.boxwidget",n="removing.boxwidget",m="removed.boxwidget";function v(r){return this.each(function(){var e=o(this),t=e.data(a);if(!t){var n=o.extend({},s,e.data(),"object"==typeof r&&r);e.data(a,t=new i(e,n))}if("string"==typeof r){if(void 0===t[r])throw new Error("No method named "+r);t[r]()}})}i.prototype.toggle=function(){!o(this.element).is(t)?this.collapse():this.expand()},i.prototype.expand=function(){var e=o.Event(g),t=o.Event(h),n=this.options.collapseIcon,r=this.options.expandIcon;o(this.element).removeClass(f),o(this.element).children(l+", "+u+", "+c).children(d).find("."+r).removeClass(r).addClass(n),o(this.element).children(u+", "+c).slideDown(this.options.animationSpeed,function(){o(this.element).trigger(e)}.bind(this)).trigger(t)},i.prototype.collapse=function(){var e=o.Event(p),t=(o.Event(r),this.options.collapseIcon),n=this.options.expandIcon;o(this.element).children(l+", "+u+", "+c).children(d).find("."+t).removeClass(t).addClass(n),o(this.element).children(u+", "+c).slideUp(this.options.animationSpeed,function(){o(this.element).addClass(f),o(this.element).trigger(e)}.bind(this)).trigger(expandingEvent)},i.prototype.remove=function(){var e=o.Event(m),t=o.Event(n);o(this.element).slideUp(this.options.animationSpeed,function(){o(this.element).trigger(e),o(this.element).remove()}.bind(this)).trigger(t)},i.prototype._setUpListeners=function(){var t=this;o(this.element).on("click",this.options.collapseTrigger,function(e){return e&&e.preventDefault(),t.toggle(o(this)),!1}),o(this.element).on("click",this.options.removeTrigger,function(e){return e&&e.preventDefault(),t.remove(o(this)),!1})};var y=o.fn.boxWidget;o.fn.boxWidget=v,o.fn.boxWidget.Constructor=i,o.fn.boxWidget.noConflict=function(){return o.fn.boxWidget=y,this},o(window).on("load",function(){o(e).each(function(){v.call(o(this))})})}(jQuery),function(o){"use strict";function i(e,t){this.element=e,this.options=t,this.hasBindedResize=!1,this.init()}var a="lte.controlsidebar",s={slide:!0},t=".control-sidebar",e='[data-toggle="control-sidebar"]',n=".control-sidebar-open",r=".control-sidebar-bg",l=".wrapper",u=".layout-boxed",c="control-sidebar-open",d="collapsed.controlsidebar",f="expanded.controlsidebar";function p(r){return this.each(function(){var e=o(this),t=e.data(a);if(!t){var n=o.extend({},s,e.data(),"object"==typeof r&&r);e.data(a,t=new i(e,n))}"string"==typeof r&&t.toggle()})}i.prototype.init=function(){o(this.element).is(e)||o(this).on("click",this.toggle),this.fix(),o(window).resize(function(){this.fix()}.bind(this))},i.prototype.toggle=function(e){e&&e.preventDefault(),this.fix(),o(t).is(n)||o("body").is(n)?this.collapse():this.expand()},i.prototype.expand=function(){this.options.slide?o(t).addClass(c):o("body").addClass(c),o(this.element).trigger(o.Event(f))},i.prototype.collapse=function(){o("body, "+t).removeClass(c),o(this.element).trigger(o.Event(d))},i.prototype.fix=function(){o("body").is(u)&&this._fixForBoxed(o(r))},i.prototype._fixForBoxed=function(e){e.css({position:"absolute",height:o(l).height()})};var h=o.fn.controlSidebar;o.fn.controlSidebar=p,o.fn.controlSidebar.Constructor=i,o.fn.controlSidebar.noConflict=function(){return o.fn.controlSidebar=h,this},o(document).on("click",e,function(e){e&&e.preventDefault(),p.call(o(this),"toggle")})}(jQuery),function(r){"use strict";function o(e){this.element=e}var i="lte.directchat",e='[data-widget="chat-pane-toggle"]',t=".direct-chat",n="direct-chat-contacts-open";function a(n){return this.each(function(){var e=r(this),t=e.data(i);t||e.data(i,t=new o(e)),"string"==typeof n&&t.toggle(e)})}o.prototype.toggle=function(e){e.parents(t).first().toggleClass(n)};var s=r.fn.directChat;r.fn.directChat=a,r.fn.directChat.Constructor=o,r.fn.directChat.noConflict=function(){return r.fn.directChat=s,this},r(document).on("click",e,function(e){e&&e.preventDefault(),a.call(r(this),"toggle")})}(jQuery),function(s){"use strict";function o(e){this.options=e,this.bindedResize=!1,this.activate()}var i="lte.layout",a={slimscroll:!0,resetHeight:!0},l=".wrapper",u=".content-wrapper",c=".layout-boxed",d=".main-footer",f=".main-header",p=".sidebar",h=".control-sidebar",e=".sidebar-menu",t=".main-header .logo",g="fixed",n="hold-transition";function r(r){return this.each(function(){var e=s(this),t=e.data(i);if(!t){var n=s.extend({},a,e.data(),"object"==typeof r&&r);e.data(i,t=new o(n))}if("string"==typeof r){if(void 0===t[r])throw new Error("No method named "+r);t[r]()}})}o.prototype.activate=function(){this.fix(),this.fixSidebar(),s("body").removeClass(n),this.options.resetHeight&&s("body, html, "+l).css({height:"auto","min-height":"100%"}),this.bindedResize||(s(window).resize(function(){this.fix(),this.fixSidebar(),s(t+", "+p).one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",function(){this.fix(),this.fixSidebar()}.bind(this))}.bind(this)),this.bindedResize=!0),s(e).on("expanded.tree",function(){this.fix(),this.fixSidebar()}.bind(this)),s(e).on("collapsed.tree",function(){this.fix(),this.fixSidebar()}.bind(this))},o.prototype.fix=function(){s(c+" > "+l).css("overflow","hidden");var e=s(d).outerHeight()||0,t=s(f).outerHeight()||0,n=t+e,r=s(window).height(),o=s(p).height()||0;if(s("body").hasClass(g))s(u).css("min-height",r-e);else{var i;i=o+t<=r?(s(u).css("min-height",r-n),r-n):(s(u).css("min-height",o),o);var a=s(h);void 0!==a&&a.height()>i&&s(u).css("min-height",a.height())}},o.prototype.fixSidebar=function(){s("body").hasClass(g)?this.options.slimscroll&&void 0!==s.fn.slimScroll&&s(p).slimScroll({height:s(window).height()-s(f).height()+"px"}):void 0!==s.fn.slimScroll&&s(p).slimScroll({destroy:!0}).height("auto")};var m=s.fn.layout;s.fn.layout=r,s.fn.layout.Constuctor=o,s.fn.layout.noConflict=function(){return s.fn.layout=m,this},s(window).on("load",function(){r.call(s("body"))})}(jQuery),function(o){"use strict";function i(e){this.options=e,this.init()}var a="lte.pushmenu",s={collapseScreenSize:767,expandOnHover:!1,expandTransitionDelay:200},e=".sidebar-collapse",t=".main-sidebar",n=".content-wrapper",r=".sidebar-form .form-control",l='[data-toggle="push-menu"]',u=".sidebar-mini",c=".sidebar-expanded-on-hover",d=".fixed",f="sidebar-collapse",p="sidebar-open",h="sidebar-expanded-on-hover",g="sidebar-mini-expand-feature",m="expanded.pushMenu",v="collapsed.pushMenu";function y(r){return this.each(function(){var e=o(this),t=e.data(a);if(!t){var n=o.extend({},s,e.data(),"object"==typeof r&&r);e.data(a,t=new i(n))}"toggle"===r&&t.toggle()})}i.prototype.init=function(){(this.options.expandOnHover||o("body").is(u+d))&&(this.expandOnHover(),o("body").addClass(g)),o(n).click(function(){o(window).width()<=this.options.collapseScreenSize&&o("body").hasClass(p)&&this.close()}.bind(this)),o(r).click(function(e){e.stopPropagation()})},i.prototype.toggle=function(){var e=o(window).width(),t=!o("body").hasClass(f);e<=this.options.collapseScreenSize&&(t=o("body").hasClass(p)),t?this.close():this.open()},i.prototype.open=function(){o(window).width()>this.options.collapseScreenSize?o("body").removeClass(f).trigger(o.Event(m)):o("body").addClass(p).trigger(o.Event(m))},i.prototype.close=function(){o(window).width()>this.options.collapseScreenSize?o("body").addClass(f).trigger(o.Event(v)):o("body").removeClass(p+" "+f).trigger(o.Event(v))},i.prototype.expandOnHover=function(){o(t).hover(function(){o("body").is(u+e)&&o(window).width()>this.options.collapseScreenSize&&this.expand()}.bind(this),function(){o("body").is(c)&&this.collapse()}.bind(this))},i.prototype.expand=function(){setTimeout(function(){o("body").removeClass(f).addClass(h)},this.options.expandTransitionDelay)},i.prototype.collapse=function(){setTimeout(function(){o("body").removeClass(h).addClass(f)},this.options.expandTransitionDelay)};var b=o.fn.pushMenu;o.fn.pushMenu=y,o.fn.pushMenu.Constructor=i,o.fn.pushMenu.noConflict=function(){return o.fn.pushMenu=b,this},o(document).on("click",l,function(e){e.preventDefault(),y.call(o(this),"toggle")}),o(window).on("load",function(){y.call(o(l))})}(jQuery),function(o){"use strict";function i(e,t){this.element=e,this.options=t,this._setUpListeners()}var a="lte.todolist",s={onCheck:function(e){return e},onUnCheck:function(e){return e}},t={data:'[data-widget="todo-list"]'},n="done";function e(r){return this.each(function(){var e=o(this),t=e.data(a);if(!t){var n=o.extend({},s,e.data(),"object"==typeof r&&r);e.data(a,t=new i(e,n))}if("string"==typeof t){if(void 0===t[r])throw new Error("No method named "+r);t[r]()}})}i.prototype.toggle=function(e){e.parents(t.li).first().toggleClass(n),e.prop("checked")?this.check(e):this.unCheck(e)},i.prototype.check=function(e){this.options.onCheck.call(e)},i.prototype.unCheck=function(e){this.options.onUnCheck.call(e)},i.prototype._setUpListeners=function(){var e=this;o(this.element).on("change ifChanged","input:checkbox",function(){e.toggle(o(this))})};var r=o.fn.todoList;o.fn.todoList=e,o.fn.todoList.Constructor=i,o.fn.todoList.noConflict=function(){return o.fn.todoList=r,this},o(window).on("load",function(){o(t.data).each(function(){e.call(o(this))})})}(jQuery),function(i){"use strict";function r(e,t){this.element=e,this.options=t,i(this.element).addClass(d),i(s+n,this.element).addClass(c),this._setUpListeners()}var o="lte.tree",a={animationSpeed:500,accordion:!0,followLink:!1,trigger:".treeview a"},s=".treeview",l=".treeview-menu",u=".menu-open, .active",e='[data-widget="tree"]',n=".active",c="menu-open",d="tree",f="collapsed.tree",p="expanded.tree";function t(n){return this.each(function(){var e=i(this);if(!e.data(o)){var t=i.extend({},a,e.data(),"object"==typeof n&&n);e.data(o,new r(e,t))}})}r.prototype.toggle=function(e,t){var n=e.next(l),r=e.parent(),o=r.hasClass(c);r.is(s)&&(this.options.followLink&&"#"!==e.attr("href")||t.preventDefault(),o?this.collapse(n,r):this.expand(n,r))},r.prototype.expand=function(e,t){var n=i.Event(p);if(this.options.accordion){var r=t.siblings(u),o=r.children(l);this.collapse(o,r)}t.addClass(c),e.slideDown(this.options.animationSpeed,function(){i(this.element).trigger(n)}.bind(this))},r.prototype.collapse=function(e,t){var n=i.Event(f);t.removeClass(c),e.slideUp(this.options.animationSpeed,function(){i(this.element).trigger(n)}.bind(this))},r.prototype._setUpListeners=function(){var t=this;i(this.element).on("click",this.options.trigger,function(e){t.toggle(i(this),e)})};var h=i.fn.tree;i.fn.tree=t,i.fn.tree.Constructor=r,i.fn.tree.noConflict=function(){return i.fn.tree=h,this},i(window).on("load",function(){i(e).each(function(){t.call(i(this))})})}(jQuery),
 ...
 */,function(e){var E=e.isDefined,A=e.isUndefined,O=e.isNumber,I=e.isObject,B=e.isArray,L=e.isString,M=e.extend,P=e.toJson;e.module("LocalStorageModule",[]).provider("localStorageService",function(){this.prefix="ls",this.storageType="localStorage",this.cookie={expiry:30,path:"/",secure:!1},this.defaultToCookie=!0,this.notify={setItem:!0,removeItem:!1},this.setPrefix=function(e){return this.prefix=e,this},this.setStorageType=function(e){return this.storageType=e,this},this.setDefaultToCookie=function(e){return this.defaultToCookie=!!e,this},this.setStorageCookie=function(e,t,n){return this.cookie.expiry=e,this.cookie.path=t,this.cookie.secure=n,this},this.setStorageCookieDomain=function(e){return this.cookie.domain=e,this},this.setNotify=function(e,t){return this.notify={setItem:e,removeItem:t},this},this.$get=["$rootScope","$window","$document","$parse","$timeout",function(l,i,u,a,n){function e(e){if(e=e||i.event,o.setItem&&L(e.key)&&y(e.key)){var t=r(e.key);n(function(){l.$broadcast("LocalStorageModule.notification.changed",{key:t,newvalue:e.newValue,storageType:c.storageType})})}}var s,c=this,d=c.prefix,f=c.cookie,o=c.notify,p=c.storageType;u?u[0]&&(u=u[0]):u=document,"."!==d.substr(-1)&&(d=d?d+".":"");function h(e){return d+e}function t(){try{var e=p in i&&null!==i[p],t=h("__"+Math.round(1e7*Math.random()));return e&&((s=i[p]).setItem(t,""),s.removeItem(t)),e}catch(e){return c.defaultToCookie&&(p="cookie"),l.$broadcast("LocalStorageModule.notification.error",e.message),!1}}function g(t,n,e){var r=k();try{if($(e),n=A(n)?null:P(n),!b&&c.defaultToCookie||"cookie"===c.storageType)return b||l.$broadcast("LocalStorageModule.notification.warning","LOCAL_STORAGE_NOT_SUPPORTED"),o.setItem&&l.$broadcast("LocalStorageModule.notification.setitem",{key:t,newvalue:n,storageType:"cookie"}),C(t,n);try{s&&s.setItem(h(t),n),o.setItem&&l.$broadcast("LocalStorageModule.notification.setitem",{key:t,newvalue:n,storageType:c.storageType})}catch(e){return l.$broadcast("LocalStorageModule.notification.error",e.message),C(t,n)}return!0}finally{$(r)}}function m(e,t){var n=k();try{if($(t),!b&&c.defaultToCookie||"cookie"===c.storageType)return b||l.$broadcast("LocalStorageModule.notification.warning","LOCAL_STORAGE_NOT_SUPPORTED"),S(e);var r=s?s.getItem(h(e)):null;if(!r||"null"===r)return null;try{return JSON.parse(r)}catch(e){return r}}finally{$(n)}}function v(){var e=k();try{var t,n,r=0;for(1<=arguments.length&&("localStorage"===arguments[arguments.length-1]||"sessionStorage"===arguments[arguments.length-1])&&$(arguments[arguments.length-(r=1)]),t=0;t<arguments.length-r;t++)if(n=arguments[t],!b&&c.defaultToCookie||"cookie"===c.storageType)b||l.$broadcast("LocalStorageModule.notification.warning","LOCAL_STORAGE_NOT_SUPPORTED"),o.removeItem&&l.$broadcast("LocalStorageModule.notification.removeitem",{key:n,storageType:"cookie"}),x(n);else try{s.removeItem(h(n)),o.removeItem&&l.$broadcast("LocalStorageModule.notification.removeitem",{key:n,storageType:c.storageType})}catch(e){l.$broadcast("LocalStorageModule.notification.error",e.message),x(n)}}finally{$(e)}}var r=function(e){return e.replace(new RegExp("^"+d,"g"),"")},y=function(e){return 0===e.indexOf(d)},b=t(),w=function(){try{return i.navigator.cookieEnabled||"cookie"in u&&(0<u.cookie.length||-1<(u.cookie="test").indexOf.call(u.cookie,"test"))}catch(e){return l.$broadcast("LocalStorageModule.notification.error",e.message),!1}}(),C=function(e,t,n,r){if(A(t))return!1;if((B(t)||I(t))&&(t=P(t)),!w)return l.$broadcast("LocalStorageModule.notification.error","COOKIES_NOT_SUPPORTED"),!1;try{var o="",i=new Date,a="";if(null===t?(i.setTime(i.getTime()+-864e5),o="; expires="+i.toGMTString(),t=""):O(n)&&0!==n?(i.setTime(i.getTime()+24*n*60*60*1e3),o="; expires="+i.toGMTString()):0!==f.expiry&&(i.setTime(i.getTime()+24*f.expiry*60*60*1e3),o="; expires="+i.toGMTString()),e){var s="; path="+f.path;f.domain&&(a="; domain="+f.domain),"boolean"==typeof r?!0===r&&(a+="; secure"):!0===f.secure&&(a+="; secure"),u.cookie=h(e)+"="+encodeURIComponent(t)+o+s+a}}catch(e){return l.$broadcast("LocalStorageModule.notification.error",e.message),!1}return!0},S=function(e){if(!w)return l.$broadcast("LocalStorageModule.notification.error","COOKIES_NOT_SUPPORTED"),!1;for(var t=u.cookie&&u.cookie.split(";")||[],n=0;n<t.length;n++){for(var r=t[n];" "===r.charAt(0);)r=r.substring(1,r.length);if(0===r.indexOf(h(e)+"=")){var o=decodeURIComponent(r.substring(d.length+e.length+1,r.length));try{var i=JSON.parse(o);return"number"==typeof i?o:i}catch(e){return o}}}return null},x=function(e){C(e,null)},T=function(){for(var e=null,t=d.length,n=u.cookie.split(";"),r=0;r<n.length;r++){for(e=n[r];" "===e.charAt(0);)e=e.substring(1,e.length);var o=e.substring(t,e.indexOf("="));x(o)}},k=function(){return p},$=function(e){return e&&p!==e&&(p=e,b=t()),b};b&&(i.addEventListener?(i.addEventListener("storage",e,!1),l.$on("$destroy",function(){i.removeEventListener("storage",e)})):i.attachEvent&&(i.attachEvent("onstorage",e),l.$on("$destroy",function(){i.detachEvent("onstorage",e)})));return{isSupported:b,getStorageType:k,setStorageType:$,setPrefix:function(e){d=e},set:g,add:g,get:m,keys:function(e){var t=k();try{if($(e),!b)return l.$broadcast("LocalStorageModule.notification.warning","LOCAL_STORAGE_NOT_SUPPORTED"),[];var n=d.length,r=[];for(var o in s)if(o.substr(0,n)===d)try{r.push(o.substr(n))}catch(e){return l.$broadcast("LocalStorageModule.notification.error",e.Description),[]}return r}finally{$(t)}},remove:v,clearAll:function(e,t){var n=k();try{$(t);var r=d?new RegExp("^"+d):new RegExp,o=e?new RegExp(e):new RegExp;if(!b&&c.defaultToCookie||"cookie"===c.storageType)return b||l.$broadcast("LocalStorageModule.notification.warning","LOCAL_STORAGE_NOT_SUPPORTED"),T();if(!b&&!c.defaultToCookie)return!1;var i=d.length;for(var a in s)if(r.test(a)&&o.test(a.substr(i)))try{v(a.substr(i))}catch(e){return l.$broadcast("LocalStorageModule.notification.error",e.message),T()}return!0}finally{$(n)}},bind:function(e,t,n,r,o){var i=m(r=r||t,o);return null===i&&E(n)?i=n:I(i)&&I(n)&&(i=M(i,n)),a(t).assign(e,i),e.$watch(t,function(e){g(r,e,o)},I(e[t]))},deriveKey:h,underiveKey:r,length:function(e){var t=k();try{$(e);for(var n=0,r=i[p],o=0;o<r.length;o++)0===r.key(o).indexOf(d)&&n++;return n}finally{$(t)}},defaultToCookie:this.defaultToCookie,cookie:{isSupported:w,set:C,add:C,get:S,remove:x,clearAll:T}}}]})}((window,window.angular)),
/**
